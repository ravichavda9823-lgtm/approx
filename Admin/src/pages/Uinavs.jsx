              ...
              <div className="col-md-6 col-lg-6">
                <div className="card">
                  <div className="card-header">
                    <div className="row align-items-center">
                      <div className="col">
                        <h4 className="card-title">Nav Tabs</h4>
                      </div>
                      {/*end col*/}
                    </div>{" "}
                    {/*end row*/}
              ...
              <div className="col-md-6 col-lg-6">
                <div className="card">
                  <div className="card-header">
                    <div className="row align-items-center">
                      <div className="col">
                        <h4 className="card-title">Nav Justified</h4>
                      </div>
                      {/*end col*/}
                    </div>{" "}
                    {/*end row*/}
              ...
              <div className="col-md-6 col-lg-6">
                <div className="card">
                  <div className="card-header">
                    <div className="row align-items-center">
                      <div className="col">
                        <h4 className="card-title">Nav Tabs With Dropdowns</h4>
                      </div>
                      {/*end col*/}
                    </div>{" "}
                    {/*end row*/}
              ...
              <div className="col-md-6 col-lg-6">
                <div className="card">
                  <div className="card-header">
                    <div className="row align-items-center">
                      <div className="col">
                        <h4 className="card-title">Nav Pills With Dropdowns</h4>
                      </div>
                      {/*end col*/}
                    </div>{" "}
                    {/*end row*/}
