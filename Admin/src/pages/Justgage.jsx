            ...
            <div className="row">
              <div className="col-sm-12">
                <div className="page-title-box d-md-flex justify-content-md-between align-items-center">
                  <h4 className="page-title">Justgage</h4>
                  <div className>
                    <ol className="breadcrumb mb-0">
                      ...
                      {/*end nav-item*/}
                      <li className="breadcrumb-item active">Justgage</li>
                    </ol>
                  </div>
                </div>
                {/*end page-title-box*/}
                ...
                <div className="card">
                  <div className="card-header">
                    <div className="row align-items-center">
                      <div className="col">
                        <h4 className="card-title">Defaults</h4>
                      </div>
                      {/*end col*/}
                    </div>{" "}
                    {/*end row*/}
              ...
              <div className="col-md-6 col-lg-6">
                <div className="card">
                  <div className="card-header">
                    <div className="row align-items-center">
                      <div className="col">
                        <h4 className="card-title">Animation Events</h4>
                      </div>
                      {/*end col*/}
                      <div className="col-auto">
                        <button
              ...
              <div className="col-md-6 col-lg-6">
                <div className="card">
                  <div className="card-header">
                    <div className="row align-items-center">
                      <div className="col">
                        <h4 className="card-title">Text Avatars Square</h4>
                      </div>
                      {/*end col*/}
                      <div className="col-auto">
                        <button
              ...
              <div className="col-md-6 col-lg-6">
                <div className="card">
                  <div className="card-header">
                    <div className="row align-items-center">
                      <div className="col">
                        <h4 className="card-title">Icon Avatars Circle</h4>
                      </div>
                      {/*end col*/}
                      <div className="col-auto">
                        <button
              ...
              <div className="col-md-6 col-lg-6">
                <div className="card">
                  <div className="card-header">
                    <div className="row align-items-center">
                      <div className="col">
                        <h4 className="card-title">Icon Avatars Square</h4>
                      </div>
                      {/*end col*/}
                      <div className="col-auto">
                        <button
              ...
              <div className="col-md-6 col-lg-6">
                <div className="card">
                  <div className="card-header">
                    <div className="row align-items-center">
                      <div className="col">
                        <h4 className="card-title">Justgage Half Size</h4>
                      </div>
                      {/*end col*/}
                    </div>{" "}
                    {/*end row*/}
              ...
              <div className="col-md-6 col-lg-6">
                <div className="card">
                  <div className="card-header">
                    <div className="row align-items-center">
                      <div className="col">
                        <h4 className="card-title">Justgage Full Size</h4>
                      </div>
                      {/*end col*/}
                    </div>{" "}
                    {/*end row*/}
