            ...
            <div className="row">
              <div className="col-sm-12">
                <div className="page-title-box d-md-flex justify-content-md-between align-items-center">
                  <h4 className="page-title">Vector</h4>
                  <div className>
                    <ol className="breadcrumb mb-0">
                      ...
                      {/*end nav-item*/}
                      <li className="breadcrumb-item active">Vector</li>
                    </ol>
                  </div>
                </div>
                {/*end page-title-box*/}
              ...
              <div className="col-12">
                <div className="card">
                  ...
                  <div className="card-body pt-0">
                    <div id="map_1" style={{ width: "100%", height: 350 }} />
                  </div>
                  {/*end card-body*/}
                </div>
                {/*end card*/}
            ...
            <div className="row justify-content-center">
              <div className="col-12">
                <div className="card">
                  ...
                  {/*end card-header*/}
                  <div className="card-body pt-0">
                    <div id="map_2" style={{ width: "100%", height: 350 }} />
                  </div>
                  {/*end card-body*/}
                </div>
                {/*end card*/}
