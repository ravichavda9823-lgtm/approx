            ...
            <div className="row">
              <div className="col-sm-12">
                <div className="page-title-box d-md-flex justify-content-md-between align-items-center">
                  <h4 className="page-title">UI-Slider</h4>
                  <div className>
                    <ol className="breadcrumb mb-0">
                      ...
                      {/*end nav-item*/}
                      <li className="breadcrumb-item active">UI-Slider</li>
                    </ol>
                  </div>
                </div>
                {/*end page-title-box*/}
                ...
                <div className="card">
                  <div className="card-header">
                    <div className="row align-items-center">
                      <div className="col">
                        <h4 className="card-title">Default Slider</h4>
                      </div>
                      {/*end col*/}
                    </div>{" "}
                    {/*end row*/}
            ...
            <div className="row justify-content-center">
              <div className="col-md-6 col-lg-6">
                <div className="card">
                  ...
                  {/*end card-header*/}
                  <div className="card-body pt-0">
                    <div id="html5" className="mb-3" />
                    <div className="row">
                      <div className="col-3">
                        <select className="form-select" id="input-select" />
                      </div>
                      <div className="col-3">
                        <input
                          type="number"
              ...
              <div className="col-md-6 col-lg-6">
                <div className="card">
                  ...
                  {/*end card-header*/}
                  <div className="card-body pt-0">
                    <div id="slider-date" className="mb-2" />
                    <span
            ...
            <div className="row justify-content-center">
              <div className="col-md-6 col-lg-6">
                <div className="card">
                  ...
                  {/*end card-header*/}
                  <div className="card-body pt-0">
                    <div id="skipstep" className="mb-2" />
                    <span
                      className="example-val d-block fw-semibold"
                      id="skip-value-lower"
                    />
