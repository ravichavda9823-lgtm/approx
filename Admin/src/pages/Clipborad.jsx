            ...
            <div className="row">
              <div className="col-sm-12">
                <div className="page-title-box d-md-flex justify-content-md-between align-items-center">
                  <h4 className="page-title">Clipboard</h4>
                  <div className>
              ...
              <div className="col-md-6 col-lg-6">
                <div className="card">
                  <div className="card-header">
                    <div className="row align-items-center">
                      <div className="col">
                        <h4 className="card-title">Clipboard Examples</h4>
                      </div>
                      {/*end col*/}
                    </div>{" "}
                    {/*end row*/}
                  ...
                  <div className="card-body pt-0">
                    <div className="input-group">
                      <input
                        ...
                        id="clipboardInput"
                        defaultValue="Welcome to Approx!"
                ...
                <div className="card">
                  <div className="card-header">
                    <div className="row align-items-center">
                      <div className="col">
                        <h4 className="card-title">Paragraph Examples</h4>
                      </div>
                      {/*end col*/}
                    </div>{" "}
                    {/*end row*/}
                  ...
                  {/*end card-header*/}
                  <div className="card-body pt-0">
                    <p id="clipboardParagraph" className="border rounded p-3">
              ...
              <div className="col-md-6 col-lg-6">
                <div className="card">
                  <div className="card-header">
                    <div className="row align-items-center">
                      <div className="col">
                        <h4 className="card-title">Textarea Examples</h4>
                      </div>
                      {/*end col*/}
                    </div>{" "}
                    {/*end row*/}
